Aqui está a conversão dos casos de teste para **Markdown** organizada e formatada para README ou documentação:
...
Se quiser, posso gerar um arquivo `.md` com este conteúdo para você baixar e usar no seu repositório GitHub.
